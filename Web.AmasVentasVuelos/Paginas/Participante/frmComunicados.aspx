<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SiteAmaszonas.Master" AutoEventWireup="true" CodeBehind="frmComunicados.aspx.cs" Inherits="Web.AmasVentasVuelos.Paginas.Participante.frmComunicados" %>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Comunicados</h5>
                        </div>
                        <ul class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label class="text-danger">(*)</label> <label for="exampleInputEmail1">Cod. Notificacion</label>
                                        <div class="input-group mb-2">
                                            <dx:ASPxTextBox ID="txtCodComunicado" runat="server" ReadOnly="true" EnableTheming="false" CssClass="form-control"></dx:ASPxTextBox>
                                        </div>
                                        <label class="text-danger">(*)</label> <label for="exampleInputEmail1">Nombre Notificacion</label>
                                        <div class="input-group mb-2">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <div class="card-body">
                               <dx:ASPxRadioButtonList ID="rbDgEstado" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rbDgEstado_SelectedIndexChanged1" RepeatDirection="Horizontal" SelectedIndex="0">
                                                <Items>
                            ...
                            <dx:ASPxGridView ID="dgComunicados" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID_COMUNICADO" Theme="MetropolisBlue">
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="ID_NOTIFICACION" Visible="true" VisibleIndex="0" FieldName="ID_COMUNICADO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="DESC_TIPO_PARTICIPANTE" VisibleIndex="1" Caption="TIPO_PARTICIPANTE">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="TIPO_PARTICIPANTE" VisibleIndex="2" Visible="false" Caption="TIPO_PARTICIPANTE">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="DENOMINACION" VisibleIndex="3" Caption="NOMBRE NOTIFICACION">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="DESCRIPCION" VisibleIndex="4"  Caption="DESCRIPCION">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="FECHA_DESDE" VisibleIndex="6" Caption="FECHA DESDE">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="FECHA_HASTA" VisibleIndex="7" Caption="FECHA HASTA">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="ESTADO" VisibleIndex="8"  Visible="false"  Caption="COD_ESTADO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="DESC_ESTADO" VisibleIndex="9" Caption="ESTADO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="OPERACION" VisibleIndex="11">
                                        <DataItemTemplate>
                                            <asp:LinkButton ID="btnModificar"  class="btn btn-icon btn-rounded btn-outline-warning !important"  runat="server" OnCommand="btnModificar_Command" CommandArgument='<%# Eval("ID_COMUNICADO") %>'>
