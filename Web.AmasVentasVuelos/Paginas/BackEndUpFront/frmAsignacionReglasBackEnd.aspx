<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SiteAmaszonas.Master" AutoEventWireup="true" CodeBehind="frmAsignacionReglasBackEnd.aspx.cs" Inherits="Web.AmasVentasVuelos.Paginas.BackEndUpFront.frmAsignacionReglasBackEnd" %>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>LISTADO DE REGLAS BACKEND</h5>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    <asp:TextBox ID="txtBuscarRegla"  CssClass="form-control" runat="server"></asp:TextBox>
        ...
        <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>REGLAS BACKEND ASIGNADAS</h5>
                                    </div>
